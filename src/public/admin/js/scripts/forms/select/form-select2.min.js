!(function (e, t, c) {
	...
	function a(e) {
		e.element;
		return e.id
			? "<i class='la la-" + c(e.element).data("icon") + "'></i>" + e.text
			: e.text;
	}
	c(".select2").select2(),
		c(".select2-placeholder").select2({
	...
	c(".select2-data-array").select2({
		...
		c(".select2-bg").each(function (e, t) {
			...
			(a = c(this).data("bgcolor-variation")),
				"" !== (s = c(this).data("text-variation")) && (s = " " + s),
				"" !== a && (a = " bg-" + a);
			var r =
				"bg-" +
				l +
		...
		c(".select2-border").each(function (e, t) {
			...
			"" !== (s = c(this).data("text-variation")) && (s = " " + s),
				"" !== (a = c(this).data("border-variation")) && (a = " border-" + a);
		...
		c(".select2-menu-bg").each(function (e, t) {
			var a = "",
				s = "",
				l = c(this).data("bgcolor");
			"" !== (a = c(this).data("bgcolor-variation")) && (a = " bg-" + a),
				"" !== (s = c(this).data("text-variation")) && (s = " " + s);
			var r =
				"bg-" +
				l +
